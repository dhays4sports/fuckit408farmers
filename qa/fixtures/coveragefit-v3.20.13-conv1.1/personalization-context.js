  ...
  const api = {
    ...
    clear: () => {
      ...
      context = deepFreeze({
        ...
        journey: { reviewReason: '', reasonKey: 'general', source: 'direct', campaign: '', referralSource: '', entryPoint: '', assessment: 'home', medium: '', handoffVersion: '', handoffContract: '', senderBuild: '', leadCaptureStatus: '', prefilled: false },
